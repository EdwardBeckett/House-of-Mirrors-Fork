 ...
 * <code>Model</code>. Typically, you use an <code>ICommand</code> to create and
 * register <code>IProxy</code> instances once the <code>Facade</code> has
...
public class Model implements IModel {
     ...
     */
    private final Map<String, IProxy> proxyMap;

    /**
     * Constructor.
     * 
     * <P>
     * This <code>IModel</code> implementation is a Singleton, so you should not
